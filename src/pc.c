...
void	sizePcPres() 
{
   ...
   printf( "size of the presentation : %ld bytes\n", size );
   printf( "pointers in the presentation : %ld\n", nrPt );
}


/*************************************************************************
** $Log: pc.c,v $
** Revision 1.6  2008-12-04 14:45:14  bg41
** Style changes -bkg
**
** Revision 1.5  2008-09-30 18:18:21  bg41
** fixed some uninitialized variables
** switched some %d to %ld -bkg
**
** Revision 1.4  2008-09-26 17:31:38  bg41
** added prototype for printGen() -bkg
**
** Revision 1.3  2008-09-25 19:27:59  bg41
** #include <stdlib> added to fix incompatible implicit 
** declaration warning -bkg
**
** Revision 1.2  2008-09-25 19:27:16  bg41
