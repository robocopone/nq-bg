...
/************************************************
** $Log: tails.c,v $
** Revision 1.3  2008-09-30 18:06:10  bg41
** removed an unused variable
** switched a %d to %ld
** initialized a variable to 0 -bkg
**
** Revision 1.2  2008-09-26 17:09:46  bg41
** updated header, added footer
** added prototype for addRow()
** added return type of void to Tail()
** added return type of void to Tails() -bkg
**
*/
