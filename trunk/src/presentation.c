...
/********************************************
** $Log: presentation.c,v $
** Revision 1.9  2008-09-30 16:44:12  bg41
** added a return statement to a funciton that was missing one -bkg
**
** Revision 1.8  2008-09-25 18:59:05  bg41
** #include <stdlib> added to fix incompatible implicit declaration warning -bkg
**
** Revision 1.7  2008-09-25 18:52:16  bg41
